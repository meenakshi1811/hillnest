        ...
        <div class="account-layout">
            ...
            <main class="account-main">
                ...
                <div class="account-profile-note">
                    ...
                    <p>Your email is linked to your account and cannot be changed here. Update your name and phone for faster checkout and delivery updates.</p>
                </div>
                ...
                <form method="POST" action="{{ route('account.profile.update') }}" class="account-profile-form" data-profile-form novalidate>
                    ...
                    <div class="account-profile-grid">
                        ...
                        <div class="account-field">
                            ...
                            <div class="account-field__wrap account-field__wrap--disabled">
                            ...
                            <p class="account-field__hint">Used for login and order confirmations</p>
                        </div>
                        ...
                        <div class="account-field">
                            ...
                            <div class="account-field__wrap">
                                ...
                                <input id="profile-phone" type="tel" name="phone" value="{{ old('phone', $user->phone) }}" autocomplete="tel" placeholder="Add your phone number" @class(['is-invalid' => $errors->has('phone')])>
                            </div>
